...
/// source: https://raw.githubusercontent.com/kaisellgren/CRC32/refs/heads/master/lib/crc32.dart
...
class CRC32 {
  ...
  static int compute(dynamic input, [int crc = 0]) {
    ...
    for (final byte in input) {
      if (!(byte >= -128 && byte <= 255)) throw FormatException("Invalid value in input: $byte");
