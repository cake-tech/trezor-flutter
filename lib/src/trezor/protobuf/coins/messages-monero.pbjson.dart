  ...
  '2': [
    {
      ...
      '5': 11,
      '6':
          '.hw.trezor.messages.monero.MoneroTransactionSourceEntry.MoneroOutputEntry',
      '10': 'outputs'
    },
    {'1': 'real_output', '3': 2, '4': 1, '5': 4, '10': 'realOutput'},
    {'1': 'real_out_tx_key', '3': 3, '4': 1, '5': 12, '10': 'realOutTxKey'},
    {
      '1': 'real_out_additional_tx_keys',
      '3': 4,
      '4': 3,
      '5': 12,
      '10': 'realOutAdditionalTxKeys'
    },
    {
      '1': 'real_output_in_tx_index',
      '3': 5,
      '4': 1,
      '5': 4,
      '10': 'realOutputInTxIndex'
    },
    ...
    {'1': 'mask', '3': 8, '4': 1, '5': 12, '10': 'mask'},
    {
      ...
      '5': 11,
      '6':
          '.hw.trezor.messages.monero.MoneroTransactionSourceEntry.MoneroMultisigKLRki',
      '10': 'multisigKLRki'
    },
    {'1': 'subaddr_minor', '3': 10, '4': 1, '5': 13, '10': 'subaddrMinor'},
  ],
  '3': [
    MoneroTransactionSourceEntry_MoneroOutputEntry$json,
    MoneroTransactionSourceEntry_MoneroMultisigKLRki$json
  ],
};
...
const MoneroTransactionSourceEntry_MoneroOutputEntry$json = {
  ...
  '2': [
    {'1': 'idx', '3': 1, '4': 1, '5': 4, '10': 'idx'},
    {
      ...
      '5': 11,
      '6':
          '.hw.trezor.messages.monero.MoneroTransactionSourceEntry.MoneroOutputEntry.MoneroRctKeyPublic',
      '10': 'key'
    },
  ],
...
const MoneroTransactionDestinationEntry$json = {
  ...
  '2': [
    {'1': 'amount', '3': 1, '4': 1, '5': 4, '10': 'amount'},
    {
      ...
      '5': 11,
      '6':
          '.hw.trezor.messages.monero.MoneroTransactionDestinationEntry.MoneroAccountPublicAddress',
      '10': 'addr'
    },
...
const MoneroGetAddress$json = {
  ...
  '2': [
    ...
    {'1': 'show_display', '3': 2, '4': 1, '5': 8, '10': 'showDisplay'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.hw.trezor.messages.monero.MoneroNetworkType',
      '7': 'MAINNET',
      '10': 'networkType'
    },
...
final $typed_data.Uint8List moneroAddressDescriptor = $convert
    .base64Decode('Cg1Nb25lcm9BZGRyZXNzEhgKB2FkZHJlc3MYASACKAxSB2FkZHJlc3M=');
...
const MoneroWatchKey$json = {
  '1': 'MoneroWatchKey',
  '2': [
    {'1': 'watch_key', '3': 1, '4': 2, '5': 12, '10': 'watchKey'},
    {'1': 'address', '3': 2, '4': 2, '5': 12, '10': 'address'},
  ],
};
...
final $typed_data.Uint8List moneroWatchKeyDescriptor = $convert.base64Decode(
    'Cg5Nb25lcm9XYXRjaEtleRIbCgl3YXRjaF9rZXkYASACKAxSCHdhdGNoS2V5EhgKB2FkZHJlc3'
    'MYAiACKAxSB2FkZHJlc3M=');
...
const MoneroTransactionInitRequest$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '5': 11,
      '6':
          '.hw.trezor.messages.monero.MoneroTransactionInitRequest.MoneroTransactionData',
      '10': 'tsxData'
    },
  ],
...
const MoneroTransactionInitRequest_MoneroTransactionData$json = {
  ...
  '2': [
    ...
    {'1': 'unlock_time', '3': 3, '4': 1, '5': 4, '10': 'unlockTime'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.hw.trezor.messages.monero.MoneroTransactionDestinationEntry',
      '10': 'outputs'
    },
    {
      '1': 'change_dts',
    ...
    {'1': 'minor_indices', '3': 10, '4': 3, '5': 13, '10': 'minorIndices'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.hw.trezor.messages.monero.MoneroTransactionRsigData',
      '10': 'rsigData'
    },
    {
      '1': 'integrated_indices',
      '3': 12,
      '4': 3,
      '5': 13,
      '10': 'integratedIndices'
    },
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.hw.trezor.messages.monero.MoneroTransactionSourceEntry',
      '10': 'srcEntr'
    },
  ],
};
...
final $typed_data.Uint8List moneroTransactionSetInputRequestDescriptor =
...
final $typed_data.Uint8List moneroTransactionInputViniAckDescriptor =
    $convert.base64Decode('Ch1Nb25lcm9UcmFuc2FjdGlvbklucHV0VmluaUFjaw==');
...
final $typed_data.Uint8List moneroTransactionAllInputsSetRequestDescriptor =
    $convert
        .base64Decode('CiRNb25lcm9UcmFuc2FjdGlvbkFsbElucHV0c1NldFJlcXVlc3Q=');
...
final $typed_data.Uint8List moneroTransactionAllInputsSetAckDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List moneroTransactionAllOutSetRequestDescriptor =
    $convert.base64Decode(
...
const MoneroTransactionAllOutSetAck$json = {
  ...
  '2': [
    ...
    {'1': 'tx_prefix_hash', '3': 2, '4': 1, '5': 12, '10': 'txPrefixHash'},
    {
      ...
      '5': 11,
      '6':
          '.hw.trezor.messages.monero.MoneroTransactionAllOutSetAck.MoneroRingCtSig',
      '10': 'rv'
    },
    {
      '1': 'full_message_hash',
...
final $typed_data.Uint8List moneroTransactionSignInputAckDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List moneroTransactionFinalRequestDescriptor =
    $convert.base64Decode('Ch1Nb25lcm9UcmFuc2FjdGlvbkZpbmFsUmVxdWVzdA==');
...
const MoneroKeyImageExportInitRequest$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '5': 11,
      '6':
          '.hw.trezor.messages.monero.MoneroKeyImageExportInitRequest.MoneroSubAddressIndicesList',
      '10': 'subs'
    },
  ],
...
final $typed_data.Uint8List moneroKeyImageExportInitAckDescriptor =
    $convert.base64Decode('ChtNb25lcm9LZXlJbWFnZUV4cG9ydEluaXRBY2s=');
  ...
  '2': [
    {
      ...
      '5': 11,
      '6':
          '.hw.trezor.messages.monero.MoneroKeyImageSyncStepRequest.MoneroTransferDetails',
      '10': 'tdis'
    },
  ],
...
const MoneroKeyImageSyncStepRequest_MoneroTransferDetails$json = {
  ...
  '2': [
    ...
    {
      '1': 'additional_tx_pub_keys',
      '3': 3,
      '4': 3,
      '5': 12,
      '10': 'additionalTxPubKeys'
    },
    {
      '1': 'internal_output_index',
      '3': 4,
      '4': 2,
      '5': 4,
      '10': 'internalOutputIndex'
    },
  ...
  '2': [
    {
      ...
      '5': 11,
      '6':
          '.hw.trezor.messages.monero.MoneroKeyImageSyncStepAck.MoneroExportedKeyImage',
      '10': 'kis'
    },
  ],
...
final $typed_data.Uint8List moneroKeyImageSyncFinalRequestDescriptor =
    $convert.base64Decode('Ch5Nb25lcm9LZXlJbWFnZVN5bmNGaW5hbFJlcXVlc3Q=');
...
final $typed_data.Uint8List moneroKeyImageSyncFinalAckDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List moneroLiveRefreshStartRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List moneroLiveRefreshStartAckDescriptor =
    $convert.base64Decode('ChlNb25lcm9MaXZlUmVmcmVzaFN0YXJ0QWNr');
...
final $typed_data.Uint8List moneroLiveRefreshStepAckDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List moneroLiveRefreshFinalRequestDescriptor =
    $convert.base64Decode('Ch1Nb25lcm9MaXZlUmVmcmVzaEZpbmFsUmVxdWVzdA==');
...
final $typed_data.Uint8List moneroLiveRefreshFinalAckDescriptor =
    $convert.base64Decode('ChlNb25lcm9MaXZlUmVmcmVzaEZpbmFsQWNr');
